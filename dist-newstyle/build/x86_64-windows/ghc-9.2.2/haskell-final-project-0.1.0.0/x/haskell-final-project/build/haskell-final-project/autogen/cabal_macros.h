...
/* package haskell-final-project-0.1.0.0 */
#ifndef VERSION_haskell_final_project
#define VERSION_haskell_final_project "0.1.0.0"
#endif /* VERSION_haskell_final_project */
#ifndef MIN_VERSION_haskell_final_project
#define MIN_VERSION_haskell_final_project(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_haskell_final_project */
...
#define CURRENT_COMPONENT_ID "haskell-final-project-0.1.0.0-inplace-haskell-final-project"
